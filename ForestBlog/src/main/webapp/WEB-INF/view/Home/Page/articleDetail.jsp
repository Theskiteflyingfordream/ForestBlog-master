                ...
                <div class="entry-content">
                    ...
                    <div id="social">
                        <div class="social-main">
                            <%--文章主体下方的赞--%>
                            <span class="like">
                                <%--a标签使用onclick注意href与onclick属性写法--%>
                                ...
                                <div id="share">
                                    <ul class="bdsharebuttonbox bdshare-button-style1-16" data-bd-bind="1503997585792">
                                        ...
                                        <%--<li><a title="分享到QQ空间" class="fa fa-qq" data-cmd="qzone"
                                               href="/article/${article.articleId}/#"></a></li>--%>
                    ...
                    <footer class="single-footer">
                        <ul class="single-meta">
                            <%--sessionScope为el表达式的内置对象注意与jsp中的session区分，el表达式不能取出session，但是可以通过pageContext取出并使用其中的setAttibute等方法--%>
                            ...
                            <%--侧边栏的隐藏与显示，文章上方--%>
                            <li class="r-hide">
                                <%--a标签使用onclick属性见https://www.cnblogs.com/huang99882008/p/11157044.html--%>
                            ...
                            <li class="comment">
                                <div id="div-comment-${c.commentId}" class="comment-body">
                                    <div class="comment-author vcard">
                                        ...
                                        <%--commentRole用于判断在这篇文章发这条评论的是否是博主--%>
                                        ...
                                        <span class="comment-meta commentmetadata">
                                            <span class="ua-info" style="display: inline;">
                                                ...
                                                <span class="comment-aux">
                                                    ...
                                                    <%--如果当前用户是该文章的作者，那么显示删除编辑，如果同时为该评论的用户（后台判断），那么可以删除，如果同时为管理员（后台判断），那么可以编辑评论--%>
