...
/*
* Note:@response中POJO对象要转成Json，则要求POJO中的属性必须都有getter方法
* Note:点赞那里得知，ajax请求如果将controller的@response注解去掉，则return交给视图解析器解析，而不是return给ajax。
* Note:@response对返回的Interger没有用，查看源码？
* */
